...
type
  ...
  /// <summary>
  ///   A descendant whose envelope is the whole structured result, the way Agent4D's TDataSet tool
  ///   will do it.
  /// </summary>
  ...
  /// <summary>
  ///   The same envelope without the matching GetOutputSchema override, which is the mistake the
  ///   tools manager reports in a DEBUG build.
  /// </summary>
  ...
  /// <summary>
  ///   A descendant that hands back an object it still owns, so it must not be freed.
  /// </summary>
