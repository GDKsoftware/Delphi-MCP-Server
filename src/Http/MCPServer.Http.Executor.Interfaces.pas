...
type
  IHttpExecutor = interface
    ...
    function Post(const Url: string; const Body: string; const Headers: TArray<TNetHeader>): IHttpResponse;
    function Post(const Url: string; const Body: TStream; const Headers: TArray<TNetHeader>): IHttpResponse;
